package com.example.microservicio_recetas.util;
...
public class RecetasSpecification {
    public static Specification obtenerRecetasPorParametros(Date minDate, Date maxDate,
            String ciPaciente, String nombrePaciente, String nombreMedico, String nombreEspecialidad,
            String diagnosticoPresuntivo) {
          try {
            return (root,query,builder) -> { 
                Join<RecetasEntity, HistoriaClinicaEntity> historiaClinicaJoin = root.join("historiaClinica");
     ...
     public static Specification obtenerRecetasDePacientePorParametros(int idPaciente,Date minDate, Date maxDate,
